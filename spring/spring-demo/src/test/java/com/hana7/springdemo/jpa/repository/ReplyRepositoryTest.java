...
class ReplyRepositoryTest extends RepositoryTest {
	...
	public void beforeEach() {
		member = memberRepository.findById(4L).orElseThrow();
	}
...
//		Assertions.assertThat(LIMIT+10).isEqualTo(replyRepository.count());
	}
...
//	    Assertions.assertThat().isEqualTo();
	...
	private Board getBoard() {
		return boardRepository.findById(22).orElseThrow();
	}
